...
export function getCnyBalanceRefreshInfo() {
  return request({
    url: '/scheduled-job/cny-balance-refresh/info',
    method: 'get'
  })
}

// 手动触发客户账户折人民币余额刷新任务
export function runCnyBalanceRefresh() {
  return request({
    url: '/scheduled-job/cny-balance-refresh/run',
    method: 'post'
  })
}
