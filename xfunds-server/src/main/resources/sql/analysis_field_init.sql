...
('yoy_current_counter',      'CURRENT_COUNTER',      '本期业务量(同比)',    'DECIMAL',  'N', 'Y', 'N', 'SUM',  'fx_trade_master', '分析指标', 80),
('yoy_last_counter',         'LAST_YEAR_COUNTER',    '去年同期业务量',      'DECIMAL',  'N', 'Y', 'N', 'SUM',  'fx_trade_master', '分析指标', 81),
...
('mom_current_counter',      'CURRENT_COUNTER',      '本期业务量(环比)',    'DECIMAL',  'N', 'Y', 'N', 'SUM',  'fx_trade_master', '分析指标', 90),
('mom_last_counter',         'LAST_PERIOD_COUNTER',  '上期业务量',          'DECIMAL',  'N', 'Y', 'N', 'SUM',  'fx_trade_master', '分析指标', 91),
